...
Show no People if there is not match 
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://kolya-movchan.github.io/react_people-table-advanced/) and add it to the PR description.
