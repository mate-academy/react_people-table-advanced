...
- Replace `radykhovska` with your Github username in the [DEMO LINK](https://radykhovska.github.io/react_people-table-advanced/) and add it to the PR description.
