...
- Replace `fromjkeee16` with your Github username in the [DEMO LINK](https://fromjkeee16.github.io/react_people-table-advanced/) and add it to the PR description.
