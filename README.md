...
- Replace `Valentyna08` with your Github username in the [DEMO LINK](https://Valentyna08.github.io/react_people-table-advanced/) and add it to the PR description.
