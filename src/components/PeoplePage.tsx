...
export const PeoplePage = () => {
  ...
  const filteredPeople = useMemo(() => {
    ...
    // below const makes so that u chose all the existing sexes if u filter by sex or whatever
    ...
    /*
It starts with everyone in the list. For each filter rule, 
if that rule is "turned on," it removes anyone who doesn't match. By the end, 
you’re left with only the people who pass all the chosen filters.
*/
