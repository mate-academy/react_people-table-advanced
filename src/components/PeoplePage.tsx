        ...
        <div className="columns is-desktop is-flex-direction-row-reverse">
          ...
          <div className="column">
            <div className="box table-container">
              ...
              {/* Show error if there is an error and loading has finished */}
              {error && !loading && <p data-cy="peopleLoadingError">{error}</p>}

              {/* Show 'no people' message if no people and no error after loading */}
              ...
              {/* Show people table if data loaded and no error */}
