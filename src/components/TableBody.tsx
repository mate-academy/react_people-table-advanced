      ...
      {filteredPeople.map(person => {
        ...
        return (
          ...
          >
            ...
            {!!motherName && listOfNames.includes(motherName) ? (
              <td>
                <Link
                  to={`/people/${findSlugOfChoosedPerson(motherName)}${search}`}
            ...
            {!!fatherName && listOfNames.includes(fatherName) ? (
              <td>
                <Link
                  to={`/people/${findSlugOfChoosedPerson(fatherName)}${search}`}
                >
                  {fatherName}
                </Link>
              </td>
