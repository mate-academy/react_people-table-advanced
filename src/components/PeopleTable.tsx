                        ...
                        <span className="icon">
                          <i
                            className={classNames('fas', {
                              ...
                              'fa-sort-up': sortField === SortField.Name && !sortOrder,
                              'fa-sort-down': sortField === SortField.Name && sortOrder,
                            })}
                          />
                        </span>
                      </SearchLink>
                        ...
                        <span className="icon">
                          <i
                            className={classNames('fas', {
                              ...
                              'fa-sort-up': sortField === SortField.Sex && !sortOrder,
                              'fa-sort-down': sortField === SortField.Sex && sortOrder,
                            })}
                          />
                        </span>
                      </SearchLink>
                        ...
                        <span className="icon">
                          <i
                            className={classNames('fas', {
                              ...
                              'fa-sort-up': sortField === SortField.Born && !sortOrder,
                              'fa-sort-down': sortField === SortField.Born && sortOrder,
                            })}
                          />
                        </span>
                      </SearchLink>
                        ...
                        <span className="icon">
                          <i
                            className={classNames('fas', {
                              ...
                              'fa-sort-up': sortField === SortField.Died && !sortOrder,
                              'fa-sort-down': sortField === SortField.Died && sortOrder,
                            })}
                          />
                        </span>
                      </SearchLink>
