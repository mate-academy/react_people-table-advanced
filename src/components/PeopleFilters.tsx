...
const degaultFilterSearchParams: FilterSearchParams = {
  centuries: null,
  query: null,
  sex: null,
};
    ...
    <nav className="panel">
          ...
          <div className="level-right ml-4">
            <SearchLink
              ...
              className={classNames('button', 'is-success', {
                'is-outlined': Boolean(centuries.length),
              })}
              params={{
                centuries: [],
              }}
      ...
      <div className="panel-block">
        <Link
          ...
          to={{
            pathname: '../',
            search: getSearchWith(searchParams, degaultFilterSearchParams),
          }}
        >
          Reset all filters
        </Link>
