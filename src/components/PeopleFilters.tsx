...
export const PeopleFilters: React.FC = () => {
  ...
  function clearCenturies() {
    return getSearchWith({ centuries: null }, searchParams);
  }
    ...
    <nav className="panel">
      ...
      <p className="panel-tabs" data-cy="SexFilter">
        ...
        <Link
          ...
          to={{ search: getSearchWith({ sex: SexType.MALE }, searchParams) }}
        >
          Male
        </Link>
        <Link
          ...
          to={{ search: getSearchWith({ sex: SexType.FEMALE }, searchParams) }}
        >
          Female
        </Link>
      </p>
