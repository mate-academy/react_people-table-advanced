...
import { SexParams } from '../types/SexParams';
  ...
  return (
    <nav className="panel">
      ...
      <p className="panel-tabs" data-cy="SexFilter">
        ...
        <SearchLink
          params={{ sex: SexParams.Male }}
          className={cn({ 'is-active': sex === SexParams.Male })}
        >
          Male
        </SearchLink>

        <SearchLink
          params={{ sex: SexParams.Female }}
          className={cn({ 'is-active': sex === SexParams.Female })}
        >
          Female
        </SearchLink>
      </p>
